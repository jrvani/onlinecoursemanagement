...
public class CourseDTO {
	...
	@NotBlank(message="Enter valid course name")
	private  String courseName;
	@NotBlank(message="Enter valid course decription")
	private  String courseDescription;
	private  int courseDurationInMonths;
	

	private  List<AssignmentsDTO> assignments= new ArrayList<AssignmentsDTO>();
	public CourseDTO() {}
