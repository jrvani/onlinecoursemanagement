...
public class ModelMapperService {
	...
	public static List<QuestionDTO> convertQuestionList(List<Question> list)
	{
		ModelMapper mapper=new ModelMapper();
		return list.stream().map(i->mapper.map(i,QuestionDTO.class)).collect(Collectors.toList());
