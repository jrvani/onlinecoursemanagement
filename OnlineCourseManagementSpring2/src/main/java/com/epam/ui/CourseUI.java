...
public class CourseUI {
	...
	@Autowired
	private AddingCourseUI addingCourseUI;
	...
	private CourseDTO inputException(CourseDTO c) {
		try {
		//AddingCourseUI add = new AddingCourseUI();
		c = addingCourseUI.addCourse();
		}
		catch(InputMismatchException e)
		{
			LOGGER.error("please type in correct form of input");
		}
		return c;
	}
