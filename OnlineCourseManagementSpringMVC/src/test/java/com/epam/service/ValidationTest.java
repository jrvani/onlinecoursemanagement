...
class ValidationTest {
	...
	@Test
	void getAllInstructorsTest() throws ListNotFound {
	...
	@Test
	void getNullInstructorTest()
	{
		when(instructorDao.getAllInstructor()).thenReturn(null);
		Validation validation=new Validation(instructorDao);
		assertThrows(ListNotFound.class, ()->{validation.getInstructors();});
	}
	@Test
	void addInstructorTest() throws NullPointerException, ListNotFound
	{
	
		
		
		List<CourseDTO> list1=new ArrayList<>();
		InstructorDTO instructorDTO=new InstructorDTO("paru","paru12","paru",list1);
	...
	@Test
	void addInstructorUnsucessfullTest() throws NullPointerException, ListNotFound
	{
