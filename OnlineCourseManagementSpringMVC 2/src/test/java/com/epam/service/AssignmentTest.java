...
import com.epam.dao.AssignmentDAOImpl;
...
class AssignmentTest {
	...
	void findTest()
	{
		 ...
		 when(assignmentDAO.find(1)).thenReturn(assignment1);
		 AssignmentService ass=new AssignmentService(assignmentDAO);
		 assertEquals("java 1", ass.find(1).getAssignmentName());
	...
	void viewTest()
	{
		 ...
		 AssignmentService ass=new AssignmentService(assignmentDAO);
		 List<AssignmentsDTO> l=ass.viewAssignments(course1);
